...
/* package universe-hierarchy-0.1.0.0 */
#ifndef VERSION_universe_hierarchy
#define VERSION_universe_hierarchy "0.1.0.0"
#endif /* VERSION_universe_hierarchy */
#ifndef MIN_VERSION_universe_hierarchy
#define MIN_VERSION_universe_hierarchy(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_universe_hierarchy */
...
#define CURRENT_COMPONENT_ID "universe-hierarchy-0.1.0.0-inplace-universe-hierarchy"
